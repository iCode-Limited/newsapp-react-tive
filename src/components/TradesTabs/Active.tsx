            ...
            <View style={styles.cardContainer}>
                <ImageBackground style={styles.cardImageContainer} imageStyle={{ borderRadius: 10 }} source={require('../../assets/images/demoPic.png')}>
                    ...
                    <View style={styles.bagContainer}>
                        <Text style={{ color: "#4D55F5", fontSize: 14 }}>Active</Text></View>
                </ImageBackground>
                ...
                <View style={styles.btn}><Text style={[globalStyles.mediumText,{color:"#fff"}]}>Mark Completed</Text></View>
                <View style={[styles.btn,{backgroundColor:"#E30000"}]}><Text style={[globalStyles.mediumText,{color:"#fff"}]}>Complain</Text></View>
                </View>
            </View>
        </View>
    )
...
const styles = StyleSheet.create({
    ...
    bagContainer: { backgroundColor: '#FFF', right: 0, position: 'absolute', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', gap: 5, width: 80, height: 30, borderTopEndRadius: 10, borderBottomStartRadius: 10 },
